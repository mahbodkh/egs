...
import app.egs.shop.domain.util.SetAuthorityConverter;
...
public class UserEntity {
    ...
    public UserEntity(
        Long id, String username, String password, String name,
        String family, String email, Date created, Date changed,
        Set<Authority> authorities, Status status
    ) {
        setId(id);
    ...
    @Transient
    public static UserEntity getBasicUser(Set<Authority> authorities, String username,String password,String name, String family) {
